  ...
  var Github = function(options) {
    ...
    Github.Repository = function(options) {
      ...
      this.editRepo = function(options, cb) {
        _request("PATCH", repoPath, options, function(err, res) {
          cb(err, res);
        });
      };
      ...
      // content can either be a string or ArrayBuffer
      // -------
      ...
      this.deleteFile = function(branch, path, sha, message, cb) {
        var data = {
          "branch": branch,
          "message": message,
          "sha": sha
      ...
      this.contents = function(branch, path, cb, sync) {
        return _request("GET", repoPath + "/contents/"+path+"?ref=" + branch, null, cb);
      };
