...
class ResourceEngine {
  ...
  listEntities(args) {
    ...
    if(!options.columns) options.columns = ['"entityId"', '"entityType"', "name", "description", "synonyms", 'created', 'edited', '"updatedBy"', '"userId"', "(SELECT COUNT(*) from documents WHERE \"entityId\"=ANY(documents.annotations)) AS count"]
