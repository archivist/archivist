<head>
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
      ...
      $.getJSON('/example/colors/index_dump.json', function (indexData) {
        console.time("load")
